...
//       <div className="flex flex-col md:flex-row justify-center items-center  py-7 md:py-8 lg:py-10 xl:py-12 gap-4 lg:gap-5 xl:gap-7 border border-[var(--color-background)]">
